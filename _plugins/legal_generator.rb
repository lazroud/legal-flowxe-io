...
module FlowxeLegal
  ...
  STRINGS = {
    'ru' => {
      ...
      'archived_banner'   => 'Вы просматриваете архивную редакцию <strong>__VERSION__</strong>.',
      'open_current'      => 'Открыть актуальную редакцию (__VERSION__)',
    ...
    'en' => {
      ...
      'archived_banner'   => 'You are viewing archived version <strong>__VERSION__</strong>.',
      'open_current'      => 'Open the current version (__VERSION__)',
